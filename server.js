...
server.get('/loving.html', function(req,res){
    ...
    server.get('/loving/flick-pick-lee-daniels-the-butler.html', function(req,res){
...
server.get('/laughing.html', function(req,res){
    ...
    // make me dynamic
    server.get('/laughing/christina-bianco-remarkable-diva-impressions.html', function(req,res){
